...
| `jira_links` | No | `jira_get_link_types`, `jira_link_to_epic`, `jira_create_issue_link`, `jira_create_remote_issue_link`, `jira_remove_remote_issue_link`, `jira_remove_issue_link` |
| `jira_worklog` | No | `jira_get_worklog`, `jira_add_worklog` |
| `jira_attachments` | No | `jira_download_attachments`, `jira_get_issue_images`, `jira_delete_attachment` |
...
| `confluence_comments` | Yes | `confluence_get_comments`, `confluence_add_comment`, `confluence_add_inline_comment`, `confluence_reply_to_comment` |
